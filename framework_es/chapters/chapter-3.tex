...
% #################################################
% #################################################
\section{Kanso Lead: El Facilitador y Documentador}\label{sec:dedicacion}
...
\begin{itemize}
    ...
    \item Friction RCA con análisis causales completos
...
Las cifras siguientes son \textbf{por equipo en alcance}, no por organización.

\begin{center}
\small
\begin{tabular}{|l|c|c|p{4.5cm}|}
\hline
\textbf{Fase} & \textbf{Horas/semana por equipo} & \textbf{FTE por equipo} & \textbf{Puede ser} \\ \hline
Kanso Lite & 2-4h & 0.05-0.10 & Part-time, rotativo \\ \hline
Kanso Core & 4-6h & 0.10-0.15 & Part-time formal \\ \hline
Kanso Full & 6-8h & 0.15-0.20 & Part-time formal, coordinado con el Kanso Office \\ \hline
\end{tabular}
\end{center}

\textbf{Regla de escala.} La dedicación del Kanso Lead se calcula por equipo cubierto y se agrega:

\begin{center}
Dedicación total = (horas/semana por equipo) $\times$ (número de equipos en alcance)
\end{center}

Un Kanso Lead de Core que atiende un solo equipo dedica 4-6 h/semana (0.10-0.15 FTE); uno que
cubre cuatro equipos dedica 16-24 h/semana (0.4-0.6 FTE). Las cifras en FTE que aparecen más
adelante en los perfiles y presupuestos son el agregado de esta misma tasa, no un estándar
distinto.

\textit{Supuestos de conversión:} 1 FTE = 40 h/semana = 2.080 h/año. El costo hora de referencia
es de \$50 USD, el mismo de la escala del anclaje cuantitativo
(\hyperref[sec:anclaje]{sección~\ref{sec:anclaje}}).
...
\textbf{Dedicación (Core)} & 4-6h/semana por equipo & 2-3h/semana/persona & 1-2h/mes \\ \hline
\textbf{Artefactos clave} & Friction Ledger, Friction RCA, Índice & Documentación de Implementación(pasos), Soluciones & Decisiones de priorización \\ \hline
...
Rota el rol cada trimestre. 4-6h/semana por equipo no es una carga grande si se distribuye. Alternativamente, un PM o Scrum Master puede asumir naturalmente.
...
Durante todo el ciclo  & Análisis Friction RCA: identificación de la causa raíz de las fricciones priorizadas mediante los 3 Whys. & Un \textit{Friction RCA} documentado por fricción: causa raíz, evidencia, nivel y contramedida propuesta. \\ \hline
A la mitad del ciclo & Sesión de revisión del \textit{Friction Ledger}: validación de prioridades y aprobación de reordenamientos. & Decisiones documentadas sobre qué fricciones atacar en el siguiente ciclo operativo del equipo. \\ \hline
...
\begin{itemize}
    ...
    \item Cada fricción prioritaria tiene un \textit{Friction RCA} con causa raíz y contramedida documentadas.
...
Friction RCA & Diagnóstico causal y reordenamiento empírico. & Causas raíz, contramedidas Kanso, impacto estimado. \\ \hline
...
\begin{center}
\begin{tabular}{|c|p{2.5cm}|p{5.5cm}|p{1.8cm}|p{1.8cm}|}
\hline
Nivel & Nombre & Características & IK & Zona \\ \hline
1 & Caótico & No hay visibilidad, alta fricción. & >25\% & Roja \\ \hline
2 & Controlado & Quick Wins activos, ledger consistente. & 15--25\% & Amarilla \\ \hline
3 & Fluido & Operación armónica, fricciones autogestionadas. & <15\% & Verde \\ \hline
\end{tabular}
\end{center}

Las bandas y las zonas son las definidas en \hyperref[sec:ik]{sección~\ref{sec:ik}}; esta tabla
sólo las traduce a estadios de madurez organizacional.

Meta global: alcanzar y sostener el Nivel 3 (IK <15\%), con evolución continua de madurez.
\\
\\
\hrule
% #################################################
...
\begin{itemize}
    ...
    \item Índice Kanso básico: Cálculo mensual manual sobre horas estimadas por el propio equipo (Precisión Nivel 1: $\pm$50\%)
...
Índice Kanso & Cálculo manual mensual sobre horas auto-reportadas por el equipo en la reunión de fricción (Precisión Nivel 1: $\pm$50\%) \\ \hline
Friction RCA & Simplificado o ausente: evaluación cualitativa sin análisis causal formal \\ \hline
...
\begin{itemize}
    ...
    \item La organización puede asignar 4-6 h/semana por equipo al rol de Kanso Lead (unos 10-15\% del tiempo de una persona por cada equipo cubierto)
...
\begin{itemize}
    ...
    \item Capacidad de asignar un Kanso Lead formal con 4-6 h/semana por equipo cubierto (0.1-0.6 FTE según el número de equipos)
...
\textbf{Componentes Activos}
\begin{itemize}
    \item Rol formal de Kanso Lead: Rol con responsabilidad y autoridad sobre el proceso
    \item Friction Ledger completo: Sistema estructurado de registro con categorización detallada
    \item Friction RCA: Análisis causal sistemático (3 Whys) de las fricciones priorizadas
    \item Índice Kanso: Cálculo quincenal o semanal sobre horas medidas con evidencia semi-automatizada (Precisión Nivel 2: $\pm$30\%)
...
Friction RCA & Análisis causal documentado por fricción con causa raíz, contramedida y pasos de reaplicación; índice consultable \\ \hline
Índice Kanso & Cálculo automatizado quincenal/semanal a partir de horas registradas en tickets, logs de CI/CD y reuniones de coordinación (Precisión Nivel 2: $\pm$30\%), con tendencias históricas \\ \hline
...
\textbf{Equipo Mínimo}
\begin{itemize}
    \item 1 Kanso Lead formal: 0.1-0.6 FTE según los equipos que cubra (\hyperref[sec:dedicacion]{sección~\ref{sec:dedicacion}})
...
Kanso Champions & Evangelistas en equipos sin Kanso Lead asignado, rol de 5-10\% tiempo \\ \hline
\end{tabular}
\end{center}
...
Enterprise Friction Ledger & Agregación de fricciones de todos los equipos con taxonomía unificada, análisis de tendencias corporativas y priorización corporativa considerando impacto cross-team y dependencias \\ \hline
...
Kanso Leads distribuidos & 0.15-0.2 FTE por equipo de 15-20 personas (6-8 h/semana) \\ \hline
...
\textbf{Total anual} & \textbf{\$425K-1.3M} (org de 200-500 personas, es decir 10-33 equipos) \\ \hline
\end{tabular}
\end{center}
...
\textbf{El Kanso Office no está exento de Kanso}

Una gobernanza que no se mide a sí misma es exactamente el \textit{Némesis} que describe el
capítulo~\ref{chap:four}: un flujo que consume tiempo sin mejorar su propio rendimiento. Kanso Full
es la parte del framework más expuesta a esa crítica, así que se somete a sus propias reglas:

\begin{itemize}
    \item Las horas del Kanso Office y de la red de Kanso Leads \textbf{cuentan como overhead} en el
    IK de la organización. No se excluyen del cálculo ni se contabilizan aparte: si la gobernanza
    crece más de lo que resuelve, el IK empeora y lo hace visible.
    \item El Office se somete a la Regla de Oro (\hyperref[sec:rop]{sección~\ref{sec:rop}}): el
    tiempo que ahorra debe exceder al que consume.
    \item \textbf{Criterio de reversión:} si el Retorno Operacional Positivo es negativo dos
    trimestres consecutivos, Kanso Full se reduce a Core. La estructura se simplifica antes que
    justificarse a sí misma.
\end{itemize}

Kanso Full no es el destino obligatorio del framework, sino la respuesta a un problema concreto de
coordinación entre equipos. Si ese problema no existe, la respuesta correcta es Core.
...
Recursos dedicados & 0.05-0.1 FTE rotativo & 0.1-0.6 FTE Kanso Lead & 2-4 FTE Kanso Office + 0.15-0.2 FTE por equipo \\ \hline
Inversión anual & \$5K-10K & \$15K-80K & \$425K-1.3M \\ \hline
...
\subsubsection{Precisión Nivel 1 - Estimación Subjetiva (Kanso Lite)}
...
\subsubsection{Precisión Nivel 2 - Medición Semi-Automatizada (Kanso Core)}
...
\subsubsection{Precisión Nivel 3 - Telemetría Automatizada (Kanso Full)}
...
Comenzar siempre con Precisión Nivel 1. Subir de nivel solo cuando:

\begin{enumerate}
    \item El equipo ya tiene disciplina de registro
    \item El IK se mantiene fuera de la zona verde ($>$15\%) durante 3 meses consecutivos
