...
\begin{enumerate}
    ...
    \item \textbf{Sistema:} define los conceptos técnicos fundamentales: fricción, costo de complejidad, Índice Kanso (IK) y los artefactos principales como el \textit{Friction Ledger}, \textit{Friction RCA} y \textit{Harmony Board}.
...
\begin{quote}
\textbf{Regla de Oro:}\label{sec:rop} La implementación de Kanso debe generar un Retorno Operacional Positivo (ROP), 
...
\hline
ITIL & Core o Full & Incident/Problem Management + Friction RCA \\
\hline
