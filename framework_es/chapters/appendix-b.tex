...
\section{Autores colaboradores}
Si bien el diseño conceptual y la autoría del Marco Kanso pertenecen a Eduardo López, las siguientes personas realizaron contribuciones sustanciales mediante revisiones exhaustivas, correcciones y mejoras:

\begin{enumerate}
    \item Joel Chan: Validación conceptual, coherencia narrativa y refinamiento estructural.
    \item Aaron Vega: Validación técnica, alineación terminológica y correcciones críticas.
\end{enumerate}

\textbf{Joel Chan}\\
Con más de 5 años de experiencia, diseño y automatizo plataformas en la nube para entregar software de forma rápida, 
segura y fiable. Mi experiencia abarca la arquitectura en AWS y Azure, la implementación de pipelines CI/CD 
(Azure DevOps, Jenkins), la orquestación con Kubernetes y la gestión de infraestructura como código con Terraform.

Colaboro con equipos multifuncionales para eliminar cuellos de botella, implementar mejores prácticas de seguridad 
(DevSecOps) y garantizar la alta disponibilidad de los servicios. Apasionado por la optimización continua, 
la observabilidad (monitorización con Prometheus/Grafana) y crear sistemas que escalen.
\\

\textbf{Aaron Vega}\\
Líder de TI orientado a resultados con más de 23 años de experiencia gestionando proyectos tecnológicos complejos 
y liderando equipos multifuncionales en Latinoamérica, Norteamérica y Europa. Reconocido por su experiencia en 
gestión de proyectos, prestación de servicios basada en ITIL y seguridad de la información. 
Trayectoria comprobada en eficiencia operativa, reducción de costos y entrega exitosa de iniciativas de TI y 
seguridad de alto impacto. Experto en la gestión de partes interesadas, el liderazgo en la escalada de incidentes y 
